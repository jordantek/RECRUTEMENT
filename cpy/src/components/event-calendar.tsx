...
import {AgendaDaysToShow, EventGap, EventHeight, WeekCellsHeight} from "@/components/constants.ts";
import {CalendarEvent, CalendarView} from "@/components/types.ts";
import {WeekView} from "@/components/week-view.tsx";
import {DayView} from "@/components/day-view.tsx";
import {CalendarDndProvider} from "@/components/calendar-dnd-context.tsx";
import {MonthView} from "@/components/month-view.tsx";
import {AgendaView} from "@/components/agenda-view.tsx";
import {addHoursToDate} from "@/components/utils.ts";
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <PlusIcon
                ...
                aria-hidden="true"
              />
              <span className="max-sm:sr-only">Ajouter un évènement</span>
            </Button>
          </div>
        </div>
