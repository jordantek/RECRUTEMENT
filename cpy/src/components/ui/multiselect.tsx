      ...
      >
        <div className="flex flex-wrap gap-1">
          {selected.map((option) => {
            return (
              ...
              >
                {option.label}
                <button
                  className="text-muted-foreground/80 hover:text-foreground focus-visible:border-ring focus-visible:ring-ring/50 absolute -inset-y-px -end-px flex size-7 items-center justify-center rounded-e-md border border-transparent p-0 outline-hidden transition-[color,box-shadow] bg-transparent outline-none focus-visible:ring-[3px]"
                  onKeyDown={(e) => {
                    if (e.key === "Enter") {
          ...
          <button
            ...
            className={cn(
                "absolute inset-y-0 right-0 flex items-center justify-center rounded-md border border-transparent p-0 text-muted-foreground transition-colors hover:text-foreground focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[5px] disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50",
              (hideClearAllButton ||
                disabled ||
                selected.length < 1 ||
