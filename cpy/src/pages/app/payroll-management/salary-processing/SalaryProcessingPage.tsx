...
import SalaryProcessingTabs from '@/pages/app/payroll-management/salary-processing/salary-processing-tabs';
...
export function SalaryProcessingPage() {
    ...
    useEffect(() => {
        usePageTitleStore
            .getState()
            .setTitle('Éléments de rémunération', 'Données de traitement mensuel des salaires', Wallet as Icon);
    ...
    return (
        <>
            <PageTitle title="Éléments de rémunération" />

            {/* Contenu administratif */}
            <div className="overflow-y-auto border-t border-gray-200 p-0">
                {selectedCompany ? (
                    <SalaryProcessingTabs
