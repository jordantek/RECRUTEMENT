...
import { LeaveAllowanceForm } from "./leave-allowance-form";
        ...
        <>
          ...
          <div className="flex items-center justify-between">
            <div className="text-left">
              <h2 className="text-lg font-semibold text-black">Allocation de congés</h2>
              <p className="text-xs text-muted-foreground">
                Gestion des allocations de congés des agents.
              </p>
            </div>
            <Button
              size="sm"
