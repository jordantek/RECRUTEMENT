...
public class BilanPeriodiqueChargeSocialeDTO {
    ...
    public BilanPeriodiqueChargeSocialeDTO(
            String debut,
            String fin,
            String employe,
    ...
    public String getNumeroCnssEmploye() {
        return numeroCnssEmploye;
    }

    public void setNumeroCnssEmploye(String numeroCnssEmploye) {
        this.numeroCnssEmploye = numeroCnssEmploye;
    }
    ...
    public BigDecimal getCnssEmploye() {
        return cnssEmploye;
    }

    public void setCnssEmploye(BigDecimal cnssEmploye) {
        this.cnssEmploye = cnssEmploye;
    }
    ...
    public String getNumeroCnssEntreprise() {
        return numeroCnssEntreprise;
    }

    public void setNumeroCnssEntreprise(String numeroCnssEntreprise) {
        this.numeroCnssEntreprise = numeroCnssEntreprise;
    }
}
